...
<html lang="<?= Yii::$app->language ?>">
    ...
    <body>
        ...
        <div class="animsition">
            ...
            <!-- .pc -->
            <div class="pc pc-usuarios-registros">
                <!-- .pc-cont -->
                <div class="pc-cont">
                    ...
                    <div class="pc-header">
                        ...
                        <img class="logo-pc" src="<?=Url::base()?>/images/live-aqua.png" alt="Live Aqua">
                    </div>
                    <!-- end - .pc-header -->
                    ...
                    <!-- .pc-registros-close -->
                    <div class="pc-registros-close js-registros-close"><i class="ion ion-close-round"></i></div>

                </div>
                <!-- end - .pc-cont -->

                <!-- .pc-ver-resgistros -->
                <!-- <span class="pc-ver-resgistros js-ver-resgistros">Ver registros</span> -->
            ...
            <div class="home-footer">
                ...
                <div class="home-footer-right">
                    <button class="btn pc-exportar js-btn-exportar ladda-button pc-exportar-view" data-style="zoom-out"><span class="ladda-label">Exportar</span></button>
                </div>
            </div>
